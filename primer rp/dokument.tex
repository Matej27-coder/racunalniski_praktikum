...
Take funkcije lahko definiramo na naslednji način. Naj bo $D \subseteq \mathbb{R}$. 
Funkcija $f: D \to \mathbb{R}$ je \emph{funkcija prvega Bairovega razreda}, če obstaja
funkcijsko zaporedje $\{f_n\}$ zveznih funkcij na $D$, ki po točkah konvergira k $f$.
Ta razred označimo z $\mathscr{B}^1(D)$ oziroma, če ne bo nevarnosti zmede, kar z $\mathscr{B}^1$.


% začetek zgleda

\begin{zgled}
        (Thomaeova funkcija). Funkcijsko zaporedje $f_n: (0, 1) \to \mathbb{R}$ definiramo na sledeč način.
        ...
        \[f(x) = \begin{cases} \frac{1}{q};  x = \frac{p}{q} \text{ je pokrajšan ulomek } p, q \in \mathbb{N} \\ 0; x je iracionalen \end{cases}\]

        Pokazali smo, da \emph{Thomaeova funkcija} pripada $\mathbb{B}^1$. 
\end{zgled}
% konec zgleda
