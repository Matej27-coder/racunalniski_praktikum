...
\begin{definicija}
    Black-Scholesov model eq:bs (ali Black-Scholes-Mertonov model) je matematični model za dinamiko finančnega trga, ki vključuje izvedene finančne instrumente. 
\end{definicija}
% konec definicije
...
\left\{      
\begin{array}{ll}
\parc{u}{v}{U}{t} = \frac{\sigma^2}{2}S^2 \frac{\partial^{2} {S}}{\partial {U}^{2}} + rS \parc{u}{v}{U}{S} - rU  \textnormal{in } \mathcal{R}^T_V \\
...
Obravnavamo primer evropske prodajne opcije s parametri $r = 0,08$, $\sigma = 0,4$, $T = 4$ in $K = 5$ in enačbo eq:bs. 
...
Enačbo eq:bs z omenjenimi parametri lahko rešimo numerično z uporabo metode končnih diferenc. 
Tabela eq:bs prikazuje napake, ki se pojavljajo pri uporabi eksplicitne metode za različne velikosti korakov
...
\label{tabela:napake} % Oznaka za sklicevanje
\begin{tabular}{cccccc}
\toprule
\textbf{$h_s / h_t$} & \textbf{1/625} & \textbf{1/1250} & \textbf{1/2500} & \textbf{1/5000} & \textbf{1/10000} \\ \midrule
1/20  & 0.18 & 0.18 & 0.18 & 0.18 & 0.18 \\
1/40  & 0.04 & 0.04 & 0.04 & 0.04 & 0.04 \\
1/80  & 0.06 & 0.06 & 0.06 & 0.06 & 0.06 \\
1/160 & 0.04 & 0.04 & 0.04 &      &      \\
1/320 & 0.02 &      &      &      &      \\ \bottomrule
\end{tabular}
